 ...
 *
 */
package com.aarc.nydrivetest.nydrive.quiz;
    ...
    public static int getResultImage(int numCorrect, int numRounds, int diff) {
        ...
        if (percentage > 90) {
            if (diff == Constants.EXTREME) {
                return R.drawable.master; //Imagenes para mostrar al final.
            } else {
            ...
            return R.drawable.not_bad;
        } else if (percentage >= 40) {
            return R.drawable.try_again;
        } else {
